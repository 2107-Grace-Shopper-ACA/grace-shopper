...
async function seed() {
  ...
  const products = await Promise.all([
    ...
    Product.create({ name: "Orecchiette", inventory: 2, price: 9, imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/1/17/Orecchiette_Pasta.JPG', description: "Concave, somewhat flattened little shells. Originated in Southern Italy with a name meaning “small ear.”", categoryId: smallPastas.id }),
    Product.create({ name: "Rotini", inventory: 100, price: 9, imageUrl: 'https://www.cooksinfo.com/wp-content/uploads/rotini.jpg', description: "Tight corkscrews that are especially good at holding onto thick sauces. You may also see them labeled as “fusilli.”", categoryId: smallPastas.id }),
    ...
    Product.create({ name: "Capellini", inventory: 7, price: 10, imageUrl: 'https://www.bullcityoliveoil.com/uploads/1/2/6/3/126303318/s942546161701459853_p260_i1_w1200.jpeg', description: "With ultra-thin strands that measure between 0.85 and 0.92 millimeters, this pasta is delicate and falls apart if overcooked. It’s often labeled as “angel hair” pasta.", categoryId: ribbonCut.id}),
    ...
    Product.create({ name: "Fettuccine", inventory: 100, price: 8, imageUrl: 'https://imagesvc.meredithcorp.io/v3/mm/image?url=https://static.onecms.io/wp-content/uploads/sites/19/2019/10/02/basic-pasta-dough-dcms-large-2000.jpg', description: "Flat, thick noodles with a name meaning “little ribbons” in Italian.", categoryId: ribbonCut.id}),
    Product.create({ name: "Pappardelle", inventory: 0, price: 9, imageUrl: 'https://nuts.com/images/rackcdn/ed910ae2d60f0d25bcb8-80550f96b5feb12604f4f720bfefb46d.ssl.cf1.rackcdn.com/0f295d4c4ee03c24-cYzopRZ2-large.jpg', description: "Large, broad, flat noodles, wider than fettuccine. Made with egg added to the dough.", categoryId: ribbonCut.id}),
    ...
    Product.create({ name: "Ziti", inventory: 9, price: 8, imageUrl: 'https://theheritagecook.com/wp-content/uploads/2013/08/CutZiti.jpg', description: "Hollow, straw-shaped noodles that are smaller and narrower than rigatoni and frequently baked into saucy, cheesy casseroles.", categoryId: tubeShaped.id}),
