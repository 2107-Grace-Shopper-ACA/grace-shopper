...
async function seed() {
  ...
  const products = await Promise.all([
    ...
    Product.create({ name: "Cappelletti", inventory: 100, price: 12, imageUrl: 'https://www.thespruceeats.com/thmb/_lHzloc-HBS6cJHeRiRGZQ-n760=/3367x2244/filters:no_upscale():max_bytes(150000):strip_icc()/cappelletti-little-hats-of-filled-pasta-4054301-step-06-d0eb7edaa69f42ef9080b3595736cec0.jpg', description: "Small, filled pasta, folded diagonally so they resemble the shape of a hat.", categoryId: stuffed.id}),
